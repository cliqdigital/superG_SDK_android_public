...
public class SuperGLog {

	private static final String LOG_TAG = "SuperGLog";
	...
	private static final String LOGFILE = "SuperGSDK.log";
...
//				}
	...
	static public String createSuperGID(Activity act) {
		...
		String package_SuperG="com.cliqdigital.supergsdk";
		try {
		...
		UUID deviceUuid = new UUID(androidId.hashCode(),
				((long) tmDeviceId.hashCode() << 32)
						|package_SuperG.hashCode()|package_name.hashCode());
