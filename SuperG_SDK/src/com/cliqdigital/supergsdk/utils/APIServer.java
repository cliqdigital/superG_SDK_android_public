...
public class APIServer {
	...
	public static String LinkPortal = "http://mobile.superg.mobi/start/?access_token=";
	public static String profileURL = "http://gasp.superg.mobi/api/v1/profile?access_token=";
	...
	public static String getURLRegister(int sid,Activity act) {
		clientID=SuperGLog.createSuperGID(act);
