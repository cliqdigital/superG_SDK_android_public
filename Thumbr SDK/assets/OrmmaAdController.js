...
(function() {
	...
	Ormma = {
		...
		resizeProperties: { }, // Set by creative
	...
	function _resize(width, height) {
	    ...
	    if ( typeof width === "undefined" &&
    		...
    		var offsetX = ( resizeProperties.offsetX || 0 );
     		var offsetY = ( resizeProperties.offsetY || 0 );
    		var allowOffscreen = ( resizeProperties.allowOffScreen || true );
    		var customClosePosition = ( resizeProperties.costomClosePosition || "top-right" )
